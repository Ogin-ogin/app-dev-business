        ...
        <div className="min-h-screen flex items-center justify-center bg-white dark:bg-[#191919] p-6 relative">
            ...
            <div className="w-full max-w-sm">
                ...
                <div className="flex flex-col gap-4">
                    <button className="w-full flex items-center justify-center gap-3 border border-black/[0.1] dark:border-white/[0.1] rounded-md py-3 hover:bg-black/[0.03] dark:hover:bg-white/[0.05] transition-colors font-medium">
